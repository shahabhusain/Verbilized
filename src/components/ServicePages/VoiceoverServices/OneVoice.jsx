          ...
          >
            {data.map((item, index) => (
              <SwiperSlide key={index}>
                <div className='border border-[#ffffff39] bg-[#ffffff12] px-6 py-10 rounded-2xl h-[465px] flex flex-col gap-4 justify-between'>
                  <div>
                    <h2 className='text-white text-[18px] font-semibold mb-2'>{item.title}</h2>
