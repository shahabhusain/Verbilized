  ...
  return (
    <div className='bg-[#030406] py-6'>
      ...
      <div className=' flex flex-col gap-3 md:w-1/2'>
        <h1 className=' text-[54px] font-[600] text-white'>Global Interpreting</h1>
        <p className=' text-[14px] font-[500] text-white'> Connecting Cultures, One Conversation at a Time</p>
