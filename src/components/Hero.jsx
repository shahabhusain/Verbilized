  ...
  return (
    <div id="Home" className=' flex flex-col md:flex-row items-center justify-between' style={{backgroundImage:`url(${bg1})`, backgroundPosition:"center", backgroundSize:"cover"}}>
        <div className=' md:w-1/2 md:ml-32 flex flex-col gap-5 md:mx-12 mx-4 mt-12 md:mt-0'>
            <h1 className=' md:text-[54px] text-[44px] font-semibold text-white md:max-w-[435px]'>Language Services Portfolio</h1>
            <p className='text-[#F4F4F4] text-[14px] font-[500] md:max-w-[455px]'>Explore the professional language services I offer in Pashto, Urdu, and English.</p>
